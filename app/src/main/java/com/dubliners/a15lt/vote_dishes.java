...
public class vote_dishes extends AppCompatActivity {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(documentList!=null && documentList.size()<6){
                    ...
                    Toast.makeText(vote_dishes.this, "Too many dishes !", Toast.LENGTH_SHORT).show();
                }
    ...
    private void showDialogBox(String alertBoxTitle, final String documentId, String defaultString, final String task){
        AlertDialog.Builder builder = new AlertDialog.Builder(vote_dishes.this);
        builder.setTitle(alertBoxTitle.trim());

        // Set up the input
        final EditText input = new EditText(vote_dishes.this);
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if(dishName.trim().equals("")){
                    Toast.makeText(vote_dishes.this, "We can't vote for a blank dish!", Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        db.collection(collectionID)
                ...
                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                    ...
                    public void onSuccess(DocumentReference documentReference) {
                        ...
                        Toast.makeText(vote_dishes.this, dishName + " added !", Toast.LENGTH_SHORT).show();
                        getDishesFromServer();
                    }
                })
        ...
        dishReference.update("dishName",dishName )
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(vote_dishes.this, "Dish Updated!", Toast.LENGTH_SHORT).show();
                        getDishesFromServer();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(vote_dishes.this, "Something went wrong, try again later.", Toast.LENGTH_SHORT).show();
                    }
                });
    }
